...
public class UIHangarObserver : UIObserver {
    ...
    public void PrepareHangarWindow()
    {
        ...
        {            
            ...
            constructButton.GetComponent<Image>().overrideSprite = showProgressBar ? UIController.current.overridingSprite : null;
    ...
    public void StartConstructing()
    {
        ...
        {
            observingHangar.constructing = false;
            PrepareHangarWindow();
        }
        else
        {
            if (GameMaster.colonyController.energyCrystalsCount >= Shuttle.STANDART_COST)
            {
                ...
                {
                    observingHangar.constructing = true;
                    PrepareHangarWindow();
                }
