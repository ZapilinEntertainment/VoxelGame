...
public class FollowingCamera : MonoBehaviour {
	...
	void LateUpdate () {
        ...
        cloudCamera.rotation = cam.rotation;	
    ...
    {
        float agl = val * 90 - cam.localRotation.eulerAngles.x;
        cam.RotateAround(transform.position, cam.TransformDirection(Vector3.right), agl);
