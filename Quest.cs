...
public class Quest  {
    ...
    public bool stepsInfoNeedsRefresh = false;
    ...
    public void CheckQuestConditions()
    {
        ...
        switch (ID)
        {
            ...
            case QuestID.Progress_HousesToMax:
                if (colony.housingLevel >= colony.hq.level) MakeQuestCompleted();
                break;
            case QuestID.Progress_2Docks:
                if (colony.docks.Count >= 2) MakeQuestCompleted();
                break;
            case QuestID.Progress_2Storages:
                if (colony.storage.warehouses.Count >= 2) MakeQuestCompleted();
                break;
            ...
            case QuestID.Progress_100Fuel:
                if (colony.storage.standartResources[ResourceType.FUEL_ID] >= 100) MakeQuestCompleted();
                break;
