...
public class ResourceType {
	...
	public readonly string description;
		...
		metal_C_ore, metal_M_ore, metal_E_ore, metal_N_ore, metal_P_ore, metal_S_ore, 
		metal_C, metal_M, metal_E, metal_N, metal_P, metal_S,
	...
	public ResourceType(string f_name, float f_mass, float f_toughness, Material m, string f_descr) {
		...
		metal_C_ore = new ResourceType(Localization.rtype_metalC_ore_name, 2.7f, 25, PoolMaster.metalC_material, Localization.rtype_metalC_descr);
		...
		metal_C = new ResourceType("Metal C", 0.7f, 50, PoolMaster.metalC_material, Localization.rtype_metalC_descr);
	...
	public static ResourceType GetResourceTypeByMaterialId(int mId) {
		...
		case PoolMaster.METAL_C_ID : return metal_C;break;
