...
public class ResourceType {
	...
	METAL_N_ID = 8, METAL_P_ID = 9,  METAL_S_ID = 10, MINERAL_F_ID = 11, MINERAL_L_ID = 12, ELASTIC_MASS_ID = 13, SUPPLIES_ID = 14,
	...
	public ResourceType(string f_name, int f_id, float f_mass, float f_toughness, Material f_material, Texture f_icon, string f_descr) {
		...
		static ResourceType() {
		resourceTypesArray = new ResourceType[22];
		...
		Food = new ResourceType(Localization.rtype_food_name, SUPPLIES_ID, 0.1f, 0.1f, PoolMaster.default_material, Resources.Load<Texture>("Textures/resource_supplies"), Localization.rtype_food_descr);
