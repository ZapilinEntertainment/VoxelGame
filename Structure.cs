...
public class Structure : MonoBehaviour {
	...
	public static Rect GetTextureRect(int f_id) {
		...
		case  SMELTERY_1_ID : return new Rect(4 *p, 6 *p, p, p);
            ...
            case MINI_GRPH_REACTOR_ID : return new Rect(3 * p, 5 *p, p, p);
		...
		case FOOD_FACTORY_4_ID : return new Rect(7 *p, 5 *p, p, p);
            case GRPH_ENRICHER_ID : return new Rect(0, 4 *p, p, p);
            case XSTATION_ID : return new Rect(p, 4 *p, p, p);
            case QUANTUM_ENERGY_TRANSMITTER_ID : return new Rect(2 * p, 4 *p, p, p);
            case CHEMICAL_FACTORY_ID : return new Rect(3 *p, 4 *p, p, p);
            ...
            case SHUTTLE_HANGAR_ID : return new Rect(7 *p, 4 *p, p, p);
            case RECRUITING_CENTER_ID : return new Rect(0, 3*p, p, p);
            case EXPEDITION_CORPUS_ID : return new Rect(p, 3 *p, p, p);
            case QUANTUM_TRANSMITTER_ID : return new Rect(2 *p, 3 *p, p, p);
        }
	}
